...
**curl test suite:** ~760 pass / ~375 fail / 47 skip out of 1196 tests (~65% pass rate, tests 1-1400)
...
Full test suite run: ~760 pass / ~375 fail / 47 skip (tests 1-1400, 30s timeout). (+46 from session start of 714).
